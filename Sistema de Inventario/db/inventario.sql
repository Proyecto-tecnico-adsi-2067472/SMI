...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-03-2021 a las 00:03:20
...
CREATE TABLE `movimientos` (
  ...
  `id_persona` int(11) NOT NULL COMMENT 'Llave foranea del Id de la persona proveniente de la tabla Personas',
...
--
ALTER TABLE `proveedores`
  MODIFY `id_proveedor` int(3) NOT NULL AUTO_INCREMENT COMMENT 'Id de el proveedor', AUTO_INCREMENT=2;
